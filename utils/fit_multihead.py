...
def fit_multihead(train, val, epochs, save_path):
    ...
    targ1 = Dense(1, activation = "sigmoid")(targ1)
    targ2 = Dense(128, activation="relu")(x)
    targ2 = Dense(1, activation = "sigmoid")(targ2)
    targ3 = Dense(128, activation="relu")(x)
    targ3 = Dense(1, activation = "sigmoid")(targ3)
    targ4 = Dense(128, activation="relu")(x)
    targ4 = Dense(1, activation = "sigmoid")(targ4)
    targ5 = Dense(128, activation="relu")(x)
    targ5 = Dense(1, activation = "sigmoid")(targ5)
    targ6 = Dense(128, activation="relu")(x)
    targ6 = Dense(1, activation = "sigmoid")(targ6)
    targ7 = Dense(128, activation="relu")(x)
    targ7 = Dense(1, activation = "sigmoid")(targ7)
    targ8 = Dense(128, activation="relu")(x)
    targ8 = Dense(1, activation = "sigmoid")(targ8)
    targ9 = Dense(128, activation="relu")(x)
    targ9 = Dense(1, activation = "sigmoid")(targ9)
    targ10 = Dense(128, activation="relu")(x)
    targ10 = Dense(1, activation = "sigmoid")(targ10)
    targ11 = Dense(128, activation="relu")(x)
    targ11 = Dense(1, activation = "sigmoid")(targ11)
    targ12 = Dense(128, activation="relu")(x)
    targ12 = Dense(1, activation = "sigmoid")(targ12)

    cnn = Model(inputs = img_input, outputs = [targ1, targ2, targ3, targ4, targ5, targ6, targ7, targ8, targ9, targ10, targ11, targ12], name = "ZFNet")
